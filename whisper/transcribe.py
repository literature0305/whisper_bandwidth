...
def transcribe(
    ...
    *,
    ...
    post_hoc_temperature: Optional[float] = None,
    post_hoc_bandwidth_enc: Optional[float] = None,
    post_hoc_bandwidth_dec: Optional[float] = None,
    **decode_options,
):
    """
    ...
    def decode_with_fallback(segment: torch.Tensor) -> DecodingResult:
        ...
        for t in temperatures:
            ...
            decode_result = model.decode(segment, options, post_hoc_temperature=post_hoc_temperature, post_hoc_bandwidth_enc=post_hoc_bandwidth_enc, post_hoc_bandwidth_dec=post_hoc_bandwidth_dec)
